<section>
    <div class="form-row align-items-center p-2">
        ...
        <div class="form-group col-12">
            ...
            <input type="number" name="catalog-new-price" class="js-settings-field form-control" data-type="module" data-name="catalog" value="<?php echo isset($value['module']['catalog-old-price']) ? $value['module']['catalog-new-price'] : '' ?>">
        </div>
        <div class="form-group col-12">
            <input type="hidden">
            <label>Количество товаров</label>
            <input type="number" name="catalog-count" class="js-settings-field js-catalog-count form-control" data-type="module" data-name="catalog" value="<?php echo isset($value['module']['catalog-count']) ? $value['module']['catalog-count'] : '' ?>">
    ...
    <div class="form-row align-items-center p-2 js-catalog-array">
        <?php
            ...
            for ($i = 0; $i < count($value['module-array']); $i++) {
                ...
                <input type="text" name="catalog-title" data-num="'.$i.'" class="form-control js-settings-field-array" data-name="catalog" data-type="module-array" value="'.$value['module-array'][$i]['catalog-title'].'">
                <label>Описание</label>
                <input type="text" name="catalog-desc" data-num="'.$i.'" class="form-control js-settings-field-array" data-name="catalog" data-type="module-array" value="'.$value['module-array'][$i]['catalog-desc'].'">
                </div>';
            }
        ?>
